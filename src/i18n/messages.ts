const messages = {
  ...
  en: {
    ...
    noCustomEndpoints: "No custom endpoints yet",
  ...
  ja: {
    ...
    customEndpoints: "カスタムエンドポイント",
    addEndpoint: "エンドポイント追加",
    endpointLabel: "名前",
    endpointUrl: "URL",
    removeEndpoint: "削除",
    noCustomEndpoints: "カスタムエンドポイントはまだありません",
